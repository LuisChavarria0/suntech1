...
import { NAV_LINKS, COMPANY_INFO, WHATSAPP_URL } from "@/lib/data/company";
          ...
          <div className="flex h-16 md:h-20 items-center justify-between gap-4">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 h-10 px-5 bg-gold-500 hover:bg-gold-400 text-navy-900 text-sm font-semibold rounded-xl transition-all duration-200 shadow-md"
              >
          ...
          >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 h-14 w-full bg-gold-500 hover:bg-gold-400 text-navy-900 text-base font-bold rounded-2xl transition-colors"
              >
